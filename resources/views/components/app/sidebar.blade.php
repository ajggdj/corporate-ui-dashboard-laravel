        ...
        <ul class="navbar-nav">
            <li class="nav-item">
                <a class="nav-link  {{ is_current_route('shop') ? 'active' : '' }}"
                    ...
                    <span class="nav-link-text ms-1">Sistema de Ordenes</span>
                </a>
            </li>
            <li class="nav-item">
                <a class="nav-link  {{ is_current_route('stock.index') ? 'active' : '' }}" href="{{ route('stock.index') }}">
                    <div
                        class="icon icon-shape icon-sm px-0 text-center d-flex align-items-center justify-content-center">
                        <svg width="30px" height="30px" viewBox="0 0 48 48" version="1.1"
                            xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
            ...
            <li class="nav-item mt-2">
                <div class="d-flex align-items-center nav-link">
                    ...
                    <span class="font-weight-normal text-md ms-2">Reportes</span>
                </div>
            </li>
            <li class="nav-item border-start my-0 pt-2">
                <a class="nav-link position-relative ms-0 ps-2 py-2 {{ is_current_route('report.index') ? 'active' : '' }}"
                    href="{{ route('report.index') }}">
                    <span class="nav-link-text ms-1">Ordenes</span>
                </a>
            </li>
            <li class="nav-item border-start my-0 pt-2">
                <a class="nav-link position-relative ms-0 ps-2 py-2 {{ is_current_route('report.indexmaquinaria') ? 'active' : '' }}"
                    href="{{ route('report.indexmaquinaria') }}">
                    <span class="nav-link-text ms-1">Ordenes maquinaria</span>
                </a>
            </li>
            <li class="nav-item">
                <a class="nav-link  {{ is_current_route('empleados.index') ? 'active' : '' }}" href="{{ route('empleados.index') }}">
                    <div
                        class="icon icon-shape icon-sm px-0 text-center d-flex align-items-center justify-content-center">
                        <svg width="30px" height="30px" viewBox="0 0 48 48" version="1.1"
                            xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
            ...
            <li class="nav-item border-start my-0 pt-2">
                <a class="nav-link position-relative ms-0 ps-2 py-2 {{ is_current_route('usuarios.index') ? 'active' : '' }}"
                    href="{{ route('usuarios.index') }}">
                    <span class="nav-link-text ms-1">Usuarios</span>
                </a>
            </li>
            <li class="nav-item border-start my-0 pt-2">
                <a class="nav-link position-relative ms-0 ps-2 py-2 {{ is_current_route('configuracion.index') ? 'active' : '' }}"
